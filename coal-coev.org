...
- How to incorporate the infection matrix to determine coevolutionary outcomes with multiple hosts.
- Host reprodution, Moran vs Wf? and possible extension to variable population size? Host reproduction on the same time scale as parasite reproduction? More generally this relates to the timescale of host drift, pathogen drift and transmission.
- Parasite reproduction with it's own genetic drift from failed infections? Or infections of resistant individuals?
