...
- Modelling host and pathogen fitness. Selection on viability or mortality of host/pathogen? Host: infection, cost of resistance. Pathogen: Ability to infect (virulence?), cost of infectivity.
*** Infection Matrix
...
** Pathogen epidemic model
- model of contact between infected individuals?

** Signals of coevolution from co-dependent genealogies
*** Hypothesis
- Coalescent tree of pathogen, scales with the contact rate/ transmission rate? Show with equilibrium of host pathogen dynamics? Results of [[cite:&zivkovic-2019-neutr-genom]].
*** Cophylogeny
