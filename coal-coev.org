...
- model of contact between infected individuals? Horizontal and vertical transmission. How to add genetic drift of the pathogen to model?
...
- add table for different cases of the model.
*** Cophylogeny
