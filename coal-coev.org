...
(I) a theoretical part aiming to understand coevolution at the level of evolutionary trees and tree sequences (i.e. genomes);

followed by part (II),  which aims to collect and characterize statistical measures and signatures of coevolutionary interactions leave in the genome (particularly with emphasis incorporating recombination, natural selection and life-history).
...
*** Ideas and further considerations
