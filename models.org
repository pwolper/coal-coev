...
#+ATTR_LATEX: :options [title={Continuous-time coevolutionary model based on epidemiological differential equations}]
#+begin_tcolorbox
...
\noindent Additionally, continuous models of coevolution include models such as birth-death processes and Moran population models (eg. models from [[cite:&macpherson-2020-coevol-does]] and [[cite:&macpherson-2021-feedb-between]]) or the Moran Infection process used by [[cite:&welch-2005-integ-geneal-epidem]]. 
...
* Approaches to host-parasite branching models
