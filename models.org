...
* Host/parasite genealogical branching models
...
*  Host-pathogen genealogy-explicit co-evolutionary models
...
** SUMMARIZE Moran Susceptible-Infected (Moran + SI)
...
** SUMMARIZE Wright-Fisher Susceptible-Infected (WF + SI)
...
#+ATTR_LATEX: :options [enhanced, title={}]
#+begin_tcolorbox
