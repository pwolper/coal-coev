...
Because the epidmiological differntial equations describe the dynamics of host compatments (i.e. susceptible and infected hosts), they do not model the pathogen population explicitly; usually the number of infected individuals TODO add citation for proxy of N_P. 
...
Other models aim to investigate the role of eco-evolutionary feedbacks, such as [[cite:&ashby-2019-under-role]], or continuous coevolutionary models with ecological dynamics, such as in  [[cite:&nuismer-2017-introd]].
